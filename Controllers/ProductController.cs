...
namespace backend_development_for_dotnet
{
    public class ProductController : Controller
    {
        private readonly DatabaseFirstDbContext _context;

        public ProductController(DatabaseFirstDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Products != null ? 
                          ...
                          Problem("Entity set 'DatabaseFirstDbContext.Products'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseFirstDbContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
